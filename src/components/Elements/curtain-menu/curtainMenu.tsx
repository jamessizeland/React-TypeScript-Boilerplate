...
function Menu({ children, open, transition }: MenuProps): JSX.Element {
  return (
    <div
...
function MenuContainer({ children }: Props): JSX.Element {
  return <div className={style.container}>{children}</div>;
}

//! You can wrap the 'a' tag with Link and pass href to Link if you are using either Create-React-App, Next.js or Gatsby
function MenuItem({ children, href }: LinkProps): JSX.Element {
  return (
    <div className="p-2">
...
export { Menu, MenuContainer, MenuItem };
